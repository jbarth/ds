...
public class MockWebApplicationContextLoader extends AbstractContextLoader {
    ...
    public ApplicationContext loadContext(final MergedContextConfiguration mergedContextConfiguration) throws Exception {
        ...
        servletContext.setAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE, webApplicationContext);
        webApplicationContext.setServletConfig(servletConfig);
        webApplicationContext.setConfigLocations(mergedContextConfiguration.getLocations());
